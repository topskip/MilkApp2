...
public final class GCMRegistrar {
    ...
    private static final String PREFERENCES = "MyPrefile";   // com.google.android.gcm";
    ...
    public static String getRegistrationId(Context context) {
    	Log.v("GCMR:OUT", "HIER SIND WIR BEIM ABRUF");
        
    	//final SharedPreferences prefs = getGCMPreferences(context);
    	SharedPreferences prefs = context.getSharedPreferences("MyPrefile", 0);        
                	
    	Log.v(TAG,"getRegistrationId---prefs:"+prefs);
    ...
    static String setRegistrationId(Context context, String regId) {
        //final SharedPreferences prefs = getGCMPreferences(context);
        SharedPreferences prefs = context.getSharedPreferences("MyPrefile", 0);
    	Log.v(TAG,"SetRegistration  prefs:"+prefs);
